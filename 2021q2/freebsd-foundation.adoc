...
* Held two new FreeBSD Fridays: https://youtu.be/IOUr7Is5FSU[Introduction to BastilleBSD] and https://youtu.be/6fwfRoDt9bQ[How to Submit a Patch to FreeBSD].
* Organized content and promoted FreeBSD Day on June 18-19, 2021
* Helped organize and run the June 2021 FreeBSD Developer Summit - videos are now posted on the https://wiki.freebsd.org/DevSummit/202106[wiki].
...
* Continued to promote the FreeBSD Office Hours series Videos from the one hour sessions can be found on the Project’s https://www.youtube.com/c/FreeBSDProject[YouTube Channel]. See the Office Hours section of this report for more information.
